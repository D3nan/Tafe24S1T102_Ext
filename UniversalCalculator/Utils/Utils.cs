...
namespace Calculator.Utils
{
	public static class Utils
	{
		...
		{
			TextBlock primaryDisplay = SimpleCalculator.mainPage.primaryDisplay;
			TextBlock secondaryDisplay = SimpleCalculator.mainPage.secondaryDisplay;
			TextBlock errorDisplay = SimpleCalculator.mainPage.errorDisplay;
		...
		{
			SimpleCalculator.mainPage.primaryDisplay.Text = "";
			SimpleCalculator.mainPage.secondaryDisplay.Text = "";
		}
